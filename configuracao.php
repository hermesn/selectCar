...
<head>
    ...
    <title>Select Car - Configuração</title>
...
<div id="head2" class="head"><div id="borda" style="margin: 10px;">
 ...
 <div id="Search" align="center" style="margin: 20px;">
    ...
    <a href="logout.php"><img id="img1" src="user.png" alt="Menu" width="35" height="35" title="Sair" align="right" style="margin: 4px;"></a>
    </form>
...
<div class="container">
  ...
  <p align="center"> <img src="user.png" width="100" height="100" title="Alterar Foto"></p><br><br> 
  <p align="center"><button type="button" class="btn btn-primary btn-block">Mudar a Senha</button>
  <button type="button" onclick="direcionar()" class="btn btn-default btn-block">Excluir Conta</button></p><br>
  <button type="button" onclick="sair()" class="btn btn-primary btn-lg btn-block">Sair</button>
  </div>
  


  <script> function sair(){ location.href="logout.php"}</script>
  <script> function direcionar(){ location.href="deletaConta.php"}</script>
</div>
...
<div id="div01" class="modal" style="width:490px; height:300px; filter:alpha(opacity=50); opacity:0.7;";> 
   ...
   <span onclick="document.getElementById('div01').style.display='none'" class="close" title="Fechar">&times;</span>
    ...
    <a href="promocoes.php"></a>     <img width="50" height="50" id="img05" src="price.png" title="Promoções" ></a>
